...
public class Futebol extends Esporte {
    ...
    public Futebol(String nome, int numeroJogadores, int duracaoPartida, String popularidade, String tamanhoCampo) {
    ...
    public void exibirRegras() {
        super.exibirRegras();
        System.out.println("Tamanho do Campo: " + this.tamanhoCampo);
    }
}
